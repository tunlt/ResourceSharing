 ...
 * @author Tu
 */
@WebServlet(name = "SendVerifyEmailAgain", urlPatterns = {"/SendVerifyEmailAgain"})
public class SendVerifyEmailAgain extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session.getAttribute("CODEVERIFY") != null) {
            ...
            if (test) {
                ...
                request.setAttribute("MESSAGE", "Send again successfull");
            }            
        } finally {
